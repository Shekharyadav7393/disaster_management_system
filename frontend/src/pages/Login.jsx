...
const DEFAULT_GITHUB_CLIENT_ID = "Ov23liBxXkVcJtxM44w3";

const Login = () => {
  const { user, login, externalLogin, loading, publicConfig } = useAuth();
      ...
      <div className="modern-auth-card">
        ...
        <div className="modern-auth-form-container">
          ...
          <div className="modern-auth-social-row">
            ...
            <button
              type="button"
              className="modern-auth-btn-social"
              onClick={() => {
                const clientId =
                  publicConfig?.githubClientId ||
